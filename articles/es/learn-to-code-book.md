...
1. Las herramientas siguen siendo primitivas.
...
[The Coders at Work][11] es un buen libro de los años 80.
...
_La última vez en Tiempo de Historia: Quincy comenzó a construir su red de desarrolladores, emprendedores y gerentes de contratación en tecnología. Estaba frecuentando hackerspaces y eventos tecnológicos en la ciudad. Pero aún no había subido a la arena y puesto a prueba su bravura..._
...
```markdown
Pasé semanas preparándome para el evento investigando a los jueces y las empresas para las que trabajaban. Investigué a los patrocinadores. Y, por supuesto, practiqué la codificación como un monje Shaolin.

Finalmente, después de un mes de preparación, llegó el gran fin de semana. Nos subimos a mi Toyota Corolla 2003 con la capa transparente descascarada, pusimos música de alta energía y comenzamos nuestro viaje de 5 horas.

En el camino, discutimos qué deberíamos construir. Estaría enfocado en la educación, por supuesto. Preferiblemente dirigido a estudiantes de preparatoria, ya que esos eran los niveles de grado en los que se centraban las empresas de los jueces.

¿Pero qué debería hacer la aplicación? ¿Cómo iba a hacer la vida de las personas más fácil?

Recordé mi propio tiempo en la preparatoria. No tenía mucho que aportar, ya que abandoné después de solo un año. (Logré estudiar y pasar el GED – Título Suficiente como lo llamábamos – mientras trabajaba en Taco Bell, antes de eventualmente ir a la universidad. Pero esa es otra historia).

Pero un punto doloroso que todavía recordaba de la preparatoria, que aún resonaba después de todos estos años: los trabajos de inglés.

Ahora, me encantaba escribir. Pero no me encantaba escribir en formato MLA, con sus reglas rígidas de citación. Solía temer preparar una página de Obras Citadas. Mi profesor siempre me descontaba puntos por no formatear mis citas correctamente.

Después de escuchar muchas ideas OK de los otros pasajeros en el coche, dije: "Tengo una idea. Deberíamos codificar una aplicación que cree citas por ti."

Y alguien se rió y dijo: "Fuera de vista."

Y Steve dijo: "Hey, ese es un buen nombre. Podríamos llamarlo Out of Cite con una 'C'."

Todos nos reímos y nos sentimos ingeniosos. Luego comenzamos a discutir los detalles de la implementación.

Cuando llegamos al lugar, había unos 100 desarrolladores más allí. Era un espacio de oficina de planta abierta, con cubículos bajos flanqueados por pizarras blancas.

Escuché susurros sobre uno de esos desarrolladores. "Hey, es ese chico que ganó el evento el año pasado," escuché que decían. Señalaban en dirección a un desarrollador con actitud rodeado de fans. "Tal vez me deje estar en su equipo."

El evento comenzó con presentaciones. Cualquiera podía subir al frente de la sala, tomar el micrófono y entregar una presentación de 60 segundos para la aplicación que querían construir.

Estaba tan nervioso que sentí que un alien estaba a punto de estallar de mi pecho. Así que, naturalmente, fui el primero en la fila. Arrancar la curita de golpe, ¿verdad?

Estaba sudando y gesticulando salvajemente mientras recorría mi presentación. Dije algo como esto: "Las citas apestan. Quiero decir, no apestan. Son necesarias. Y necesitas agregarlas a tus trabajos. Pero preparar citas apesta. Hagamos una aplicación que llene tu página de Obras Citadas por ti. ¿Quién está conmigo?"

La sala estaba en silencio. Luego la gente se dio cuenta de que había terminado de hablar y me dieron un aplauso obligatorio. El maestro de ceremonias tomó el micrófono de mis manos y se lo dio a la siguiente persona, y yo volví saltando a mi asiento.

Después de las presentaciones, era hora de formar equipos. Nuestro contingente de Santa Bárbara se miró entre sí y dijo "Supongo que somos un equipo."

Conseguimos la contraseña de wifi y tomamos la mejor de las áreas de trabajo: una oficina en la esquina que tenía una puerta que realmente podrías cerrar.

Comencé a dibujar maquetas de interfaz de usuario en la pizarra. Dije, "Queremos algo que siempre esté a un clic de distancia. Justo en la barra de menú de tu navegador."

"Como un complemento de navegador," dijo Steve.

"Sí. Construyamos un complemento de navegador."

Les mostré ejemplos de los tres formatos que podrían requerir los ensayos: MLA, APA y Chicago.

"¿Podríamos generar los tres a la vez, para que solo tengan que copiar y pegar?" pregunté.

"Podemos hacer algo mejor que eso," dijo Steve. "Podemos tener un botón para cada uno que ponga la cita directamente en su portapapeles."

Trabajamos rápido, creando un MVP (Producto Mínimo Viable) simple para la noche del viernes. Todo lo que hacía era obtener los metadatos del sitio web actual y estructurarlos como una cita. Pero funcionaba.

Como era mi primer hackathon, no quería el estrés de quedarme en un hostal. Así que me di el lujo de obtener una habitación de hotel. Teníamos dos camas gemelas, así que cada noche rotábamos quién tenía que dormir en el suelo.

La mañana del sábado, nuestras ambiciones crecieron. Caminé hacia la pizarra y le dije al equipo: "Citar sitios web es genial y todo. Pero muchas de las cosas que los estudiantes citan están en libros o artículos académicos. Necesitamos poder generar citas para esos también."

Encontramos una API que podríamos usar para obtener información de citas basada en ISBN (un número de serie utilizado para libros). Y armamos un script que podía buscar artículos académicos basados en su DOI (un número de serie utilizado para artículos académicos), luego raspar datos de la página de resultados.

Para la noche del sábado, el código para nuestro complemento de navegador realmente estaba tomando forma. Así que me senté y comencé a preparar las diapositivas de la presentación. Dejé mucho del código final a mis compañeros de equipo mientras ensayaba mi presentación una y otra vez durante horas.

Aunque era mi turno de dormir en una cama, apenas pude cerrar los ojos debido a los nervios. Aquí estaba, justo en el corazón del ecosistema tecnológico. Silicon Valley.

Como maestro, solía dar charlas frente a mis colegas – a veces docenas de ellos. Pero esto era diferente.
```

```markdown
Incapaz de dormir, abrí mi correo electrónico. El personal de Startup Weekend había enviado un correo, que incluía un PDF de un libro. Era una combinación no oficial de los clásicos de las startups tecnológicas [4 Steps to the Epiphany][15] y [The Lean Startup][16].
...
En la fiesta posterior, almacené pizza, así tendría más tiempo para hacer contactos con todos los que pude. Me conecté en LinkedIn. Seguí en Twitter. Nos tomamos selfies juntos y usé mucho el hashtag del evento.
```
...
![Image](https://www.freecodecamp.org/news/content/images/2023/01/image__2000-1338_.png) _El Gran Lebowski (izquierda). No tenía trabajo, no tenía habilidades, no tenía energía. Pero tenía mucha tranquilidad._
...
Así, el proceso de contratación de desarrolladores en la mayoría de las grandes empresas es paranoico a más no poder. Tal vez debería serlo. Pero desafortunadamente, esto hace que sea más difícil para _todos_ conseguir un trabajo de desarrollador – incluso para los candidatos más honestos.
...
3.  Crear contenido enfocado en desarrolladores
4.  Ascender en las filas trabajando en empresas con un "nombre conocido"
5.  Construir un portafolio de clientes freelance
6.  Comenzar tu propio proyecto de código abierto, empresa o caridad
...
![Imagen](https://www.freecodecamp.org/news/content/images/2023/01/raisedadead__Mrugesh_Mohapatra__--.png) _El perfil de GitHub de Mrugesh Mohapatra, quien hace un montón de desarrollo de plataforma y DevOps para freeCodeCamp.org. Nota qué tan verde está su barra de actividad. 2,208 contribuciones en el último año._
...
Lee la guía completa de Hillary Nyakundi para [empezar con código abierto][17].
...
Para muchas personas, incluyéndome a mí, eso significa pasar tiempo en los pensamientos de otras personas. Libros. Video ensayos. Experiencias interactivas como [novelas visuales][18].
...
Mi amigo Andrew Brown es un ex-CTO de Toronto que ha pasado todos los exámenes principales de DevOps. Crea [cursos gratuitos para prepararte para todas las certificaciones de AWS, Azure, y Google Cloud][20], y también dirige un servicio de preparación de exámenes.
...
Si contribuyes al código abierto durante suficiente tiempo, _construirás_ una reputación como desarrollador.

Si participas en el circuito de hackatones el tiempo suficiente, _construirás_ una reputación como desarrollador.
...
_La última vez en Hora de la Historia: Quincy se lanzó a la circuit de hackathons con fuerza, ganando incluso algunos de los eventos. Estaba construyendo su reputación como desarrollador que era "peligroso" con JavaScript. No súper hábil. Solo peligroso..._
...
**X** es un candidato trampa que algunos gerentes primerizos pueden cometer el error de contratar. Si tienes curiosidad por saber por qué contratar a X sería una mala idea, lee [Despedimos a nuestro mejor talento. La mejor decisión que tomamos.][22]
...
![Imagen](https://www.freecodecamp.org/news/content/images/2023/01/85L921BMzXxKhVySPo9gxWamr5J4QLFJaVEn.png) _De 291 solicitudes, obtuvo finalmente 8 ofertas._
...
![Imagen](https://www.freecodecamp.org/news/content/images/2023/01/bDp3eVv6VQS3Og3ulVpwp6dDylIybdpRczsD.png) _Para la semana 12, sus ofertas de salario inicial eran casi el doble de lo que eran en la semana 2._

La tasa de este desarrollador para conseguir entrevistas es bastante fuerte. Y su capacidad de negociación también era fuerte. Puedes [leer más sobre su proceso si tienes curiosidad][24].
...
1. Realizar una evaluación de codificación en línea de tus habilidades o una "Pantalla Telefónica".
2. Y luego, si pasas eso, una segunda entrevista técnica por teléfono o videollamada.
3. Y luego, si pasas eso, una entrevista "en el sitio" donde viajas a la oficina de una empresa. Estas generalmente incluyen varias entrevistas con RRHH, gerentes de contratación y desarrolladores con los que podrías trabajar.
...
Definitivamente ayuda ser fluido en el idioma en el que estás entrevistándote y conocer la jerga adecuada. Puedes aprender mucho de esto escuchando regularmente podcasts de tecnología, como [el Podcast de freeCodeCamp][25].
...
He escrito extensamente sobre [cómo negociar el salario de tu oferta de trabajo como desarrollador][26].
...
![Imagen](https://www.freecodecamp.org/news/content/images/2023/01/92508.jpeg) _Smithers de Los Simpson_
...
Por cierto, una vez que has trabajado como desarrollador en una empresa durante un año o más, es posible que desees pedir un aumento. He escrito extensamente sobre [cómo pedir un aumento como desarrollador][27]. Pero todo se reduce a lo mismo: apalancamiento.
...
He escrito extensamente sobre [por qué los reclutadores son una herramienta subestimada en tu caja de herramientas][28].
...
1.  Dado que se les paga basado en tu salario inicial, están inclinados a ayudarte a negociar un salario inicial lo más alto posible.
2.  Cuantos más candidatos ubiquen, y cuanto más rápido los ubiquen, más dinero ganan los reclutadores. Así que querrán ayudarte a conseguir un trabajo lo más rápido posible para poder pasar a otros buscadores de empleo.
3.  Dado que solo se les paga si tienes éxito como empleado (y te quedas al menos 90 días), intentarán asegurarse de que eres competente y de que encajas bien con la cultura de la empresa.
...
1.  Es mucho más fácil conseguir un cliente freelance que un trabajo a tiempo completo.
2.  El trabajo freelance es menos arriesgado ya que puedes hacerlo sin renunciar a tu trabajo diario.
3.  Puedes empezar a cobrar por programar más pronto y comenzar a construir tu portafolio de trabajo profesional más pronto.
...
_La última vez en Hora de la Historia: Quincy consiguió su primer trabajo como desarrollador en una startup tecnológica local. Iba a trabajar como uno de una docena de desarrolladores manteniendo una base de código grande y sofisticada. Y no tenía idea de lo que estaba haciendo..._
...
Finalmente logré que la base de código de la empresa funcionara en mi nuevo portátil. Era una aplicación de Ruby on Rails que había crecido durante 5 años. Ejecuté el comando `rake stats` y vi que tenía millones de líneas de código. Me estremecí. ¿Cómo podría comprender todo eso alguna vez?
...
Cada vez que alguien rompía la compilación, bajaba la última versión de nuestra rama principal y usaba `git bisect` para intentar identificar el commit que la rompió.
...
![Imagen](https://www.freecodecamp.org/news/content/images/2023/01/is_it_worth_the_time_2x-1.png) _Este gráfico de XKCD puede ayudarte a decidir si vale la pena la inversión de tiempo para automatizar una tarea._
...
Me lancé de lleno, organizando contratos freelance para mantener las luces encendidas. Y busqué un apartamento en el Área de la Bahía, justo al cruzar el puente desde el corazón palpitante de la tecnología en South of Market, San Francisco.
